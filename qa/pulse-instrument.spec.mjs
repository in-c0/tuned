...
// `follow_open`, `feed_render` and `follow_rss` are on this list because the server allows them,
// not because this page emits them: all three belong to a public feed page — its follow dialog,
// its script running at all, and the RSS option inside that dialog — and none of them may ever
// fire on `/`, whose views are EXP-011's denominator.
...
const ALLOWED = ["landing_render", "landing_engage", "application_start", "follow_open", "feed_render", "follow_rss"];
const NEVER_HERE = ["follow_open", "feed_render", "follow_rss"];
