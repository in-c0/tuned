...
| **Why it needs you** | **Access, not authority.** Your **A** (2026-08-20 15:04 UTC) stands and is not re-asked. The executor's GitHub access is scoped to `in-c0/tuned` and it holds no identity at that venue, so it cannot open the issue — an *unavailable credentials* stop condition, never routed around. |
...
| **Blocker age** | From **`2026-08-24T21:43:45.078Z`**, the instant item 247 made the act admissible again. Last surfaced in the [2026-08-25 03:33:11 UTC reviewer directive](https://github.com/in-c0/tuned/issues/1#issuecomment-5404716623). |
...
| | |
| --- | --- |
| **Last materially updated** | 2026-08-25 14:05 Sydney (2026-08-25 04:05 UTC) |
