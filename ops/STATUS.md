...
holds no instrument that can write to any third party at all (egress 403 to every host including
`docs.google.com`; its one external vantage is a GET-only reader), so **A-2 stays withdrawn as
unperformable**.
**Fastest path, and the only one: you submit the issue yourself** (~2 minutes, you hold the account).
Preflight A4 **✅ 0.0h**, item **246** published 2026-08-21T09:35:56Z — **lapses 2026-08-24T09:35:56Z
(19:35 Sydney Monday)**. The duplicate check was last read 2026-08-20 and is not re-claimed as fresh ·
